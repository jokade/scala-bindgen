...
# NSDate
$bindgen -t objc -P cocoa.foundation -o $out/NSDate.scala $f/NSDate.h $@

# NSLocale
$bindgen -t objc -P cocoa.foundation -o $out/NSLocale.scala $f/NSLocale.h $@

# NSTimeZone
$bindgen -t objc -P cocoa.foundation -o $out/NSTimeZone.scala $f/NSTimeZone.h $@

# NSMutableDictionary
#$bindgen -t objc -P cocoa.foundation -o $out/NSMutableDictionary.scala $f/NSMutableDictionary.h $@
